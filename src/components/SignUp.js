    ...
    <>
      <form className="signup d-flex flex-column" onsubmit="handleSignUp(event)" novalidate>
        ...
        <div className="input-control name-input mb-4">
          <label for="firstname">Firstname <span className="required">*</span></label>
        ...
        <div className="input-control name-input mb-4">
          <label for="lastname">Lastname <span className="required">*</span></label>
        ...
        <div className="input-control password-input mb-4">
          <label for="password-repeat">Password check <span className="required">*</span></label>
